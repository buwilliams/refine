...
def _build_gap_chat_preamble(conn: sqlite3.Connection, gap_id: str,
    ...
    parts: list[str] = [
        ...
        "",
        "Stay scoped to THIS GAP by default. Do not enumerate `.refine/gaps`,",
        "scan sibling Gap files, or inspect Feature-ordered Gaps unless the user",
        "explicitly asks for Feature-level context or the current Gap context",
        "below directly requires that comparison. Prefer the current Gap JSON,",
        "the recent activity listed below, and files in the live worktree.",
        "",
        "## Gap context",
        f"- Name: {row['name']}",
        f"- ID: {gap_id}",
