...
- on upgrade, formerly enabled target-app test commands are imported into Quality once and remain enforced until explicitly replaced by a non-empty plain-text Quality test set.
