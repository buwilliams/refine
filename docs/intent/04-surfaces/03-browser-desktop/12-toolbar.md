...
- **Multi-Tool Surface**: System, Files, Terminal, Standalone, and Gap chat belong together as operational aids.
- **Contextual Chat**: chat can attach to a Gap or remain standalone.
- **Stateful But Recoverable**: toolbar state should persist enough to survive normal navigation without owning product state.

## Purpose

The toolbar exists to keep supporting work close at hand. Users need system notices, source files, terminal access, standalone agent conversations, and Gap chat while they inspect or edit the main surface.
...
- Gap chat supports conversation tied to specific work.

Current implementation details that matter to intent:

- toolbar tab order is System, Files, Terminal, Standalone, then opened Gap chats;
