...
Refine should become the local operating layer for agentic software work. It should let people and AI systems express work as direct Goal prompts, organize those Goals into larger Features, converge on outcomes larger than any one change as Missions, preserve the context needed to act on them, and move the work through implementation, quality, review, and merge.
