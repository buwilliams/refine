...
- Capabilities
  ...
  - Workflow
    ...
    - [In Progress](03-capabilities/03-workflow/03-in-progress.md)
    - [Ready Merge](03-capabilities/03-workflow/04-ready-merge.md)
    - [Build](03-capabilities/03-workflow/05-build.md)
    - [QA](03-capabilities/03-workflow/06-qa.md)
