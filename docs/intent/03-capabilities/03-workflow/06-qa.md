...
- The configured agent evaluates every project Quality test against the isolated Goal candidate for `pre_merge`, or against the exact integrated target checkout for `post_build`, deciding how to run each plain-text test.
