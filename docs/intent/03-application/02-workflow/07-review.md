...
Email intake creates ordinary backlog Goals. Fetching does not approve Review, add follow-up Rounds, or send resolution replies. Normal manual acceptance and recovery remain available.
