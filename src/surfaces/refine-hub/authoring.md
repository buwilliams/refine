...
Run **Update Refine Hub** from the **Skills** section in the left rail, or choose **Run Skill** next to Refine Hub in **Hubs → Manage Hubs**. Describe what readers should understand after the update. For release notes, include the version and coverage dates.
