...
- A Custom Release Skill uses the shared release commands for major, minor, and patch previews and a normal reviewable preparation Goal with persisted stages. Publication remains a separate, explicitly confirmed action after merge, with clean-main, version/tag, credentials, remote, deployment, and GitHub-release verification.
