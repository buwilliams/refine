...
- the shell contains a collapsible left navigation rail, banners, main and window content areas, and Guide panel;
- hash routing drives dynamic windows, Dashboard, Features, Goals, Changes, Settings, Node, Project, modals, import, and Plan flows;
