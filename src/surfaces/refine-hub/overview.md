...
<img src="images/refine.png" alt="refine" style="width: 100%; height: auto;">
...
- **Skills** - connect workflow activity and custom actions to reusable agent instructions, with scoped configuration, parameters, and durable execution evidence. [Configure Skills](docs/runbooks/configure-skills.md).
...
The collapsible left rail brings Dashboard, Project Planning, Features, Goals, Changes, Control, Settings, and open tool windows together. Choose **Tools** for an agent, terminal, files or logs. Each window uses the full content area. **Search** and **Ctrl+K** (⌘K on Mac) work from every screen. [Find your way around Refine](product/navigation.md), or [see the 4.3.2 changes](releases/4.3.2.md).
