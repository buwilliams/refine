...
Click anywhere on the Main, Skills, or Hubs header to expand or collapse that section. Click the Node or Reporter row to change its selection. The borderless “Collapse menu <<” control at the bottom collapses the rail to icons; “>>” expands it. On a small screen, the rail opens as a drawer. Your rail and section preferences survive reload. Dropdowns and section toggles align at the right edge; Node, Reporter, and Tools keep the shared hover style without a button border. Node and Reporter menus have visible headings and creation actions.

For everyday tasks, see [Find your way around Refine](../product/navigation.md).

![Refine dashboard with the consolidated navigation rail](images/4.3.2/dashboard.png?v=abc8cc53b40c)

*Screenshots use an example workspace to show the current interface without exposing live project data.*

![Tools dropdown with Skills and Hubs in the rail](images/4.3.2/tools.png?v=e2d28a7d484d)
...
![Files window using the full content area](images/4.3.2/files.png?v=84a8bd64ff5d)

![Full-width Todo List](images/4.3.2/todo.png?v=c5caf4fbb63d)
...
![Control screen with icon actions for the target app and processes](images/4.3.2/control.png?v=653ae433b6e9)
