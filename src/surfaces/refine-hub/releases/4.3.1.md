...
**Changes since September 2, 2026, through 4.3.1.** The 4.3 series brings agent instructions into one place, makes Goal progress and failures easier to follow, improves workflow recovery, and introduces Hubs for documentation and reports.
...
The built-in **Metrics Hub** reports on Goals, rounds, delivery trends, aging work, and activity by node and reporter. Switch between day, week, month, quarter, and year views. Refresh the report directly or run its **Update Metrics Hub** Skill; the saved aggregate is shared through refine-state. [Understand the metrics](../product/metrics.md).
