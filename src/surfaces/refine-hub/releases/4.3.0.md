...
No configuration changes are required to read the hub. Documentation source has moved into `src/surfaces/refine-hub/`; update any personal scripts that read the old repository paths.
