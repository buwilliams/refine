...
pub fn commands_catalog() -> Value {
    ...
    json!({
        ...
        "hints": {
            ...
            "runbooks": "Task-oriented guides live in src/surfaces/refine-hub/docs/runbooks/.",
...
mod tests {
    ...
    fn operational_runbooks_use_current_cli_and_layout_contracts() {
        ...
        let runbooks_dir = root.join("src/surfaces/refine-hub/docs/runbooks");
        ...
        let cli = Cli::command();
        let index =
            fs::read_to_string(root.join("src/surfaces/refine-hub/docs/runbooks/README.md"))
                .unwrap();
        ...
        for path in paths {
                ...
                && path.file_name().and_then(|name| name.to_str()) != Some("README.md")
            {
                ...
                assert!(
                    ...
                    "src/surfaces/refine-hub/docs/runbooks/README.md does not list {file_name}"
                );
            }
