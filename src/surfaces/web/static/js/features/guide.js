  ...
  },
  {
    ...
    items: [
      ...
      guideItem("runtime-parallel-run-cap", "Parallel-run cap", "Educate and configure",
        "Leave Parallel-run cap blank for automatic shared-host admission, which reserves most detected CPU and available memory for Docker and other expensive work. Entering a positive number is an explicit node-level override.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("quality-instructions", "Instructions", "Educate and optional config",
        ...
        "Default: blank until the team has Quality preferences to enforce.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("process-management", "Process management", "Educate",
        ...
        { hash: "#/node/processes", selector: "[data-testid='process-manager-table']" },
        { canUseDefault: false }),
