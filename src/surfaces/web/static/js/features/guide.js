  ...
  },
  {
    ...
    items: [
      ...
      guideItem("application-rebuild", "Rebuild", "Educate and configure",
        ...
        { hash: "#/node/target-app", selector: "#s-target-rebuild-command" }),
      ...
      guideItem("application-rebuild-timeout", "Rebuild timeout", "Educate and optional config",
        ...
        "Default: 300 seconds.",
        { hash: "#/node/target-app", selector: "#s-target-rebuild-timeout" }),
  ...
  },
  {
    ...
    items: [
      guideItem("nav-application-status", "Application status", "Educate",
        "The application status indicator shows target-app state and opens the Node process view for start, stop, rebuild, sync, and checks.",
