  ...
  },
  {
    ...
    items: [
      guideItem("skills-configure", "Skills", "Educate and configure",
        "Each Skill has one trigger, instructions, scope, and optional inputs. Choose a workflow point for automatic execution or Custom for manual execution. Clone a Skill to use it elsewhere. Refine determines the expected result from the trigger.",
      ...
      guideItem("skills-run", "Run a Skill", "Educate and operate",
        "Enabled Custom Skills appear in Skills and the command palette. Fill in any requested inputs to open the Skill in its own agent tab, independently of Goals. Use the tab to follow the work or stop the agent.",
        "Action: use New Skill in Skills to create a Skill from any screen.",
  ...
  },
  {
    ...
    items: [
      guideItem("release-workflow", "Semantic releases", "Educate and operate",
        "Use a Release Skill from Skills to preview a semantic version, prepare a reviewable Goal, and publish after approval through the existing release commands.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("nav-agent-status", "Agent status", "Educate",
        "The agent status row in Settings summarizes active Agent work and workflow admission state, then links to Node processes.",
