...
const GUIDE_CATEGORIES = [
  {
    ...
    items: [
      guideItem("quickstart-add-app", "Add app", "Configure",
        ...
        { hash: "#/settings/application", selector: "#s-project-add" },
        { canUseDefault: false }),
      guideItem("quickstart-create-node", "Create node", "Configure",
        ...
        { hash: "#/settings/application", selector: "#node-add" },
        { canUseDefault: false }),
      guideItem("quickstart-generate-ai", "Generate with AI", "Configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-generate-ai" },
        { canUseDefault: false }),
      guideItem("quickstart-start", "Start", "Configure",
        ...
        { hash: "#/settings/processes", selector: "#s-target-run-start" },
        { canUseDefault: false }),
    ],
  },
  {
    ...
    items: [
      guideItem("node-educate", "Settings only for this machine", "Educate",
        ...
        { hash: "#/settings/application", selector: "#settings-tabs" }),
      ...
      guideItem("node-active", "Activate node", "Educate and configure",
        ...
        { hash: "#/settings/application", selector: "[data-node-activate], .filter-pill, .table" },
        { canUseDefault: false }),
      ...
      guideItem("node-connection", "Node connection", "Educate and configure",
        ...
        { hash: "#/settings/application", selector: "[data-node-remote-configure]" },
        { canUseDefault: false }),
      ...
      guideItem("project-known-apps", "Known apps", "Educate and configure",
        ...
        { hash: "#/settings/application", selector: "#s-project-select" }),
      guideItem("reporter-add", "Add reporter", "Educate and configure",
        ...
        { hash: "#/settings/reporters", selector: "#r-add" },
        { canUseDefault: false }),
      guideItem("reporter-manage", "Manage reporters", "Educate and configure",
        ...
        { hash: "#/settings/reporters", selector: "[data-rename], [data-rmerge], [data-rdel]" },
        { canUseDefault: false }),
      guideItem("reporter-merge-into", "Merge into", "Educate and configure",
        ...
        { hash: "#/settings/reporters", selector: "[data-rmerge]" },
        { canUseDefault: false }),
      guideItem("node-copy-settings-source", "Source node", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-application-copy-node" },
        { canUseDefault: false }),
      ...
      guideItem("application-agent-subpath", "Agent subpath", "Educate and optional config",
        ...
        { hash: "#/settings/target-app", selector: "#s-subpath" }),
      guideItem("application-git-remote", "Git remote", "Educate and optional config",
        ...
        "Default: origin.",
        { hash: "#/settings/target-app", selector: "#s-git-remote" }),
      guideItem("application-merge-target", "Integration branch", "Educate and optional config",
        ...
        { hash: "#/settings/target-app", selector: "#s-merge-target" }),
      guideItem("application-url", "App URL", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-app-url" }),
      guideItem("application-start", "Start", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-start-instructions" }),
      guideItem("application-stop", "Stop", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-stop-instructions" }),
      guideItem("application-build", "Build", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-build-instructions" }),
      guideItem("application-status", "Status command", "Educate and configure",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-status-command" }),
      guideItem("application-working-directory", "Working directory", "Educate and optional config",
        ...
        "Default: blank, which uses the repo root.",
        { hash: "#/settings/target-app", selector: "#s-target-cwd" }),
      guideItem("application-environment", "Environment overrides", "Educate and optional config",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-env" }),
      guideItem("application-start-timeout", "Start timeout", "Educate and optional config",
        ...
        "Default: 120 seconds.",
        { hash: "#/settings/target-app", selector: "#s-target-start-timeout" }),
      guideItem("application-stop-timeout", "Stop timeout", "Educate and optional config",
        ...
        "Default: 60 seconds.",
        { hash: "#/settings/target-app", selector: "#s-target-stop-timeout" }),
      guideItem("application-build-timeout", "Build timeout", "Educate and optional config",
        ...
        "Default: 300 seconds.",
        { hash: "#/settings/target-app", selector: "#s-target-build-timeout" }),
      guideItem("application-test-timeout", "Test timeout", "Educate and optional config",
        ...
        "Default: 600 seconds.",
        { hash: "#/settings/target-app", selector: "#s-target-test-timeout" }),
      guideItem("application-status-timeout", "Status timeout", "Educate and optional config",
        ...
        "Default: 10 seconds.",
        { hash: "#/settings/target-app", selector: "#s-target-status-timeout" }),
      guideItem("application-log-path", "Log path", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/settings/target-app", selector: "#s-target-log-path" }),
      guideItem("application-http-check-url", "HTTP check URL", "Educate and optional config",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-http-url" }),
      guideItem("application-tcp-host", "TCP host", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/settings/target-app", selector: "#s-target-tcp-host" }),
      guideItem("application-tcp-port", "TCP port", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/settings/target-app", selector: "#s-target-tcp-port" }),
      guideItem("application-process-check-command", "Process check command", "Educate and optional config",
        ...
        { hash: "#/settings/target-app", selector: "#s-target-process-command" }),
      ...
      guideItem("runtime-parallel-run-cap", "Parallel-run cap", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-cap" }),
      guideItem("runtime-automatic-resource-budget-percent", "Automatic resource budget percent", "Educate and configure",
        ...
        "Default: 70 percent.",
        { hash: "#/settings/runtime", selector: "#s-automatic-resource-budget-percent" }),
      guideItem("runtime-branch-name-pattern", "Branch name pattern", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-pattern" }),
      guideItem("runtime-agent-idle-timeout", "Agent idle timeout", "Educate and configure",
        ...
        "Default: 900 seconds.",
        { hash: "#/settings/runtime", selector: "#s-idle" }),
      guideItem("runtime-agent-hard-cap", "Agent hard cap", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-hard" }),
      guideItem("runtime-worker-memory-limit", "Worker memory limit", "Educate and configure",
        ...
        "Default: 2000 MB.",
        { hash: "#/settings/runtime", selector: "#s-worker-memory" }),
      guideItem("runtime-ui-memory-limit", "UI memory limit", "Educate and configure",
        ...
        "Default: 2000 MB.",
        { hash: "#/settings/runtime", selector: "#s-ui-memory" }),
      guideItem("runtime-worker-cpu-priority", "Worker CPU priority", "Educate and configure",
        ...
        "Default: low.",
        { hash: "#/settings/runtime", selector: "#s-worker-cpu-priority" }),
      guideItem("runtime-resource-isolation", "Resource isolation mode", "Educate and configure",
        ...
        "Default: auto.",
        { hash: "#/settings/runtime", selector: "#s-resource-isolation" }),
      guideItem("runtime-agent-limit-pause", "Rate/token limit pause", "Educate and configure",
        ...
        "Default: 1 minute.",
        { hash: "#/settings/runtime", selector: "#s-agent-limit-pause" }),
      guideItem("runtime-chat-idle-timeout", "Standalone chat idle timeout", "Educate and configure",
        ...
        "Default: 300 seconds.",
        { hash: "#/settings/runtime", selector: "#s-chat-idle" }),
      guideItem("runtime-backlog-promote", "Auto-promote backlog to todo", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-backlog-promote" }),
      guideItem("runtime-worktree-cleanup", "Inactive worktree hibernation", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-worktree-cleanup-delay" }),
      guideItem("runtime-project-update-pulse", "Refine state synchronization", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-state-sync-debounce" }),
      guideItem("runtime-file-browser-ignore", "File browser ignore patterns", "Educate and configure",
        ...
        { hash: "#/settings/runtime", selector: "#s-file-browser-ignore" }),
      guideItem("runtime-ai-provider", "AI provider", "Educate and configure",
        ...
        "Default: Claude Code.",
        { hash: "#/settings/runtime", selector: "#s-cli" }),
    ],
  },
  {
    id: "project",
    title: "Events and Skills",
    description: "Reusable agent instructions and the activity that triggers them.",
    items: [
      guideItem("events-configure", "Events", "Educate and configure",
        "The Events tab lists custom Events and their launch parameters. Use Add event... in Controls to create one from any screen. System Events are available when assigning Events to a Skill.",
        "Default: Plan, Implement, Quality, and Governance Enter each have a blocking Skill.",
        { hash: "#/settings/events", selector: "[data-testid='settings-events']" }),
      guideItem("skills-configure", "Skills", "Educate and configure",
        "Skills contain plain-text instructions, a result role, scope, and optional typed parameters. Assign system or custom Events here, with execution mode, order, node overrides, and Goal, System, or Event context mappings. The Skill and its assignments save together.",
        "Action: edit the default Skills to describe your project's intent and required evidence.",
        { hash: "#/settings/skills", selector: "[data-testid='settings-skills']" }),
      guideItem("events-run", "Custom Events", "Educate and operate",
        "Enabled custom Events appear in Controls and the command palette. The launch form collects parameters and defaults; execution history retains results and offers cancellation.",
        "Default: no custom Events until you add one.",
        { hash: "#/settings/events", selector: "[data-event-history]" }),
      guideItem("application-test", "Target-app tests", "Educate and configure",
        ...
        { hash: "#/settings/application", selector: "#s-target-test-commands" }),
    ],
  },
  {
    id: "system",
    ...
    items: [
      ...
      guideItem("process-management", "Process management", "Educate",
        ...
        { hash: "#/settings/processes", selector: "[data-testid='process-manager-table']" },
        { canUseDefault: false }),
      guideItem("process-pause-workflow", "Pause or unpause workflow", "Educate",
        ...
        { hash: "#/settings/processes", selector: "[data-toggle-workflow]" }),
    ],
  },
  {
    id: "main-nav",
    ...
    items: [
      ...
      guideItem("nav-agent-status", "Agent status", "Educate",
        "The agent status row in Controls summarizes active Agent work and workflow admission state, then links to Node processes.",
        "Action: use this row to inspect running Agents separately from paused workflow automation.",
