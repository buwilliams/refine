...
const GUIDE_CATEGORIES = [
  {
    ...
    items: [
      ...
      guideItem("quickstart-create-node", "Create node", "Configure",
        ...
        { hash: "#/node/nodes", selector: "#node-add" },
        { canUseDefault: false }),
      guideItem("quickstart-generate-ai", "Generate with AI", "Configure",
        ...
        { hash: "#/node/application", selector: "#s-target-generate-ai" },
        { canUseDefault: false }),
  ...
  },
  {
    ...
    items: [
      guideItem("node-educate", "Settings only for this machine", "Educate",
        ...
        { hash: "#/node/nodes", selector: "#settings-tabs" }),
      ...
      guideItem("node-active", "Activate node", "Educate and configure",
        ...
        { hash: "#/node/nodes", selector: "[data-node-activate], .filter-pill, .table" },
        { canUseDefault: false }),
      ...
      guideItem("node-copy-settings-source", "Source node", "Educate and configure",
        "Source node chooses another node to copy Application or Runtime settings from into the active node.",
        "Default: copy only when the source node is known to have the desired local configuration.",
        { hash: "#/node/application", selector: "#s-application-copy-node" },
        { canUseDefault: false }),
      ...
      guideItem("application-agent-subpath", "Agent subpath", "Educate and optional config",
        ...
        { hash: "#/node/application", selector: "#s-subpath" }),
      guideItem("application-merge-target", "Merge target branch", "Educate and optional config",
        ...
        { hash: "#/node/application", selector: "#s-merge-target" }),
      guideItem("application-url", "App URL", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-app-url" }),
      guideItem("application-start", "Start", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-start-command" }),
      guideItem("application-stop", "Stop", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-stop-command" }),
      guideItem("application-rebuild", "Rebuild", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-rebuild-command" }),
      guideItem("application-auto-rebuild", "Automatic application rebuild", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-auto-rebuild" }),
      guideItem("application-status", "Status command", "Educate and configure",
        ...
        { hash: "#/node/application", selector: "#s-target-status-command" }),
      guideItem("application-working-directory", "Working directory", "Educate and optional config",
        ...
        "Default: blank, which uses the repo root.",
        { hash: "#/node/application", selector: "#s-target-cwd" }),
      guideItem("application-environment", "Environment overrides", "Educate and optional config",
        ...
        { hash: "#/node/application", selector: "#s-target-env" }),
      guideItem("application-start-timeout", "Start timeout", "Educate and optional config",
        ...
        "Default: 120 seconds.",
        { hash: "#/node/application", selector: "#s-target-start-timeout" }),
      guideItem("application-stop-timeout", "Stop timeout", "Educate and optional config",
        ...
        "Default: 60 seconds.",
        { hash: "#/node/application", selector: "#s-target-stop-timeout" }),
      guideItem("application-rebuild-timeout", "Rebuild timeout", "Educate and optional config",
        ...
        "Default: 300 seconds.",
        { hash: "#/node/application", selector: "#s-target-rebuild-timeout" }),
      guideItem("application-status-timeout", "Status timeout", "Educate and optional config",
        ...
        "Default: 10 seconds.",
        { hash: "#/node/application", selector: "#s-target-status-timeout" }),
      guideItem("application-log-path", "Log path", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/node/application", selector: "#s-target-log-path" }),
      guideItem("application-http-check-url", "HTTP check URL", "Educate and optional config",
        ...
        { hash: "#/node/application", selector: "#s-target-http-url" }),
      guideItem("application-tcp-host", "TCP host", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/node/application", selector: "#s-target-tcp-host" }),
      guideItem("application-tcp-port", "TCP port", "Educate and optional config",
        ...
        "Default: blank.",
        { hash: "#/node/application", selector: "#s-target-tcp-port" }),
      guideItem("application-process-check-command", "Process check command", "Educate and optional config",
        ...
        { hash: "#/node/application", selector: "#s-target-process-command" }),
  ...
  },
  {
    id: "project",
    title: "Project",
    description: "Project-wide settings shared by all refine nodes.",
    items: [
      guideItem("project-educate", "Project-wide settings", "Educate",
        "Project settings are stored with the app and shared by all refine nodes. Use them for product intent, quality policy, and governance.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("process-agent-processes", "Subprocesses", "Educate",
        "Subprocesses lists active and recent agent, chat, helper, and runner work so you can inspect runtime state and stop stuck work.",
      ...
      guideItem("process-runner-processes", "Subprocess history", "Educate",
        "Subprocess history shows background work such as rebuilds, merges, projection-cache work, and queued jobs.",
...
function guideContextMessage() {
  if (guideState.context === "app-created") {
    return "This app was initialized for refine. Start with Project Application, then create or select the right Node for this machine.";
  }
  if (guideState.context === "app-existing") {
    return "This app already has refine state. Review Project settings, then select or create the right Node for this machine.";
  }
  if (guideState.context === "no-app") {
    return "No app is attached. Configure Refine from Project Application, then select or create the right Node for this machine.";
  }
