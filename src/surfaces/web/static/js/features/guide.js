...
const GUIDE_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("runtime-worktree-cleanup", "Terminal worktree cleanup", "Educate and configure",
        "Todo Goals are state-only. Once admitted to in-progress, each Goal round gets an isolated worktree; clean done or cancelled worktrees are reclaimed after the retention delay. Dirty, active, review, standalone, state, and unrecognized ignored content remain protected.",
        "Default: immediately. Cargo target directories and Node node_modules are recognized automatically; add only target-app cache paths that are safe to delete.",
