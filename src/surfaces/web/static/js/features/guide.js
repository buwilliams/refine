  ...
  },
  {
    ...
    items: [
      guideItem("events-configure", "Events", "Educate and configure",
        "Events connect workflow Enter and Exit activity or a manual request to ordered Skills. Choose blocking, background, or context bindings and explicit node overrides.",
      ...
      guideItem("skills-configure", "Skills", "Educate and configure",
        "Skills contain plain-text instructions, a result role, scope, and optional typed parameters. Goal context, System context, Event input, and defaults supply additional context.",
