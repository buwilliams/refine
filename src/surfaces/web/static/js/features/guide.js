...
const GUIDE_CATEGORIES = [
  {
    ...
    items: [
      ...
      guideItem("quickstart-create-node", "Create node", "Configure",
        "Create a node so this machine, operator, or environment owns its Gaps and local runtime settings.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("node-create", "Create node", "Educate and configure",
        "Create a node when this machine, operator, or environment should own separate Gaps and local runtime settings.",
      ...
      guideItem("node-manage", "Nodes", "Educate and configure",
        "Nodes separate ownership, runtime configuration, reporters, application commands, and optional remote connection details while sharing project-level policy.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("application-test", "Target-app tests", "Educate and configure",
        "Target-app tests are the supervised CLI commands Refine runs during workflow QA.",
        "Default: configure the commands that match the target app test runners.",
        { hash: "#/project/quality", selector: "#s-target-test-commands" }),
