  ...
  },
  {
    ...
    items: [
      ...
      guideItem("application-merge-target", "Merge target branch", "Educate and optional config",
        "Merge target branch chooses the branch Goal worktrees are based on and where merged work lands. Blank follows the host checkout.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("quality-enabled", "QA enabled", "Educate and configure",
        "QA enabled controls whether the Quality agent runs as part of Goal workflow checks.",
