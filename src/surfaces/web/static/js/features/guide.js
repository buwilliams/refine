  ...
  },
  {
    ...
    items: [
      guideItem("process-management", "Process management", "Educate",
        ...
        { hash: "#/node/processes", selector: ".managed-process-table, [data-toggle-background-processes]" },
        { canUseDefault: false }),
      guideItem("process-stop-background", "Stop background processes", "Educate",
        "Stopping background processes keeps the UI running while pausing workflow automation, chats, agents, queued builds, and active background operations.",
        "Default: leave background processes running unless you need a maintenance pause.",
        { hash: "#/node/processes", selector: "[data-toggle-background-processes]" }),
      guideItem("process-pause-agents", "Pause or unpause agents", "Educate",
        ...
        { hash: "#/node/processes", selector: "[data-toggle-agent-processes]" }),
