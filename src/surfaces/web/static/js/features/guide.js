  ...
  },
  {
    ...
    items: [
      ...
      guideItem("process-management", "Process management", "Educate",
        ...
        { canUseDefault: false }),
      guideItem("process-pause-workflow", "Pause or resume workflow", "Educate",
        "Pausing blocks new Goal admission and quiesces automatic Git sync and inactive-worktree cleanup at safe boundaries. Already active Goal executions continue unless stopped separately. Resuming makes admission and those repository workers eligible again.",
