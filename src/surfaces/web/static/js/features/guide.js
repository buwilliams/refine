  ...
  },
  {
    ...
    items: [
      ...
      guideItem("skills-run", "Run a Skill", "Educate and operate",
        "Enabled Custom Skills appear in Controls and the command palette. Fill in any requested inputs to open the Skill in its own agent tab, independently of Goals. Use the tab to follow the work or stop the agent.",
        "Action: use Add skill... in Controls to create a Skill from any screen.",
  ...
  },
  {
    ...
    items: [
      ...
      guideItem("nav-reporter", "Reporter", "Educate and configure",
        ...
        { selector: '[data-topbar-picker="reporter"]' },
        { canUseDefault: false }),
