    ...
    pub fn apply_state_recovery_decision(
        ...
        let _guard = match lock.try_lock() {
            ...
            Err(TryLockError::WouldBlock) => {
                return Err(RefineError::StateRecoveryConflict {
                    reason:
                        crate::process::supervisor::errors::StateRecoveryConflictReason::GitBusy,
                    message: "Repository Git operations are busy; recovery was not started."
                        .to_string(),
                });
            }
