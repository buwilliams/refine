...
impl FileMergerService {
    ...
    fn merge_gap_branch(
        ...
        work_items.advance_automated_gap_status(gap_id, GapStatus::AwaitingRebuild)?;
        self.append_job_log(
            job_id,
            gap_id,
            "info",
            "Workflow status changed: ready-merge -> awaiting-rebuild",
        ...
        self.append_job_log(
            ...
            gap_id,
            "info",
            "Workflow status changed: awaiting-rebuild -> review",
            None,
        )?;
