...
use crate::infrastructure::git::repository::{FileGitRepository, command_failed};
...
pub fn classify(repo: &FileGitRepository, a: &str, b: &str) -> RefineResult<Ancestry> {
...
mod tests {
    ...
    impl RepoFixture {
        ...
        fn service(&self) -> FileGitRepository {
