...
use crate::infrastructure::runtime::host_resources::HostResources;
...
pub(crate) fn trimmed_command_text(output: &HostCommandOutput) -> String {
...
pub(crate) fn validate_commitish(commit: &str) -> RefineResult<()> {
...
pub(crate) fn validate_branch_name(branch: &str) -> RefineResult<()> {
...
pub(crate) fn validate_head_branch_ref(reference: &str) -> RefineResult<()> {
