...
pub fn parse_structured_import_result(
    ...
    let candidates = crate::application::agent_io::structured_output::json_candidates(
        output,
        &crate::application::agent_io::structured_output::DecodeOptions::new("import drafts JSON"),
    );
