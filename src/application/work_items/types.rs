...
pub struct GoalAuthoringRequest {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize)]
pub struct GoalAuthoringDuplicate {
    pub id: String,
    pub name: String,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize)]
pub struct GoalAuthoringDuplicateMove {
    pub moved: bool,
    pub from: GoalStatus,
    pub to: GoalStatus,
    pub reason: Option<String>,
...
pub struct GoalAuthoringResult {
    pub created: bool,
    pub goal: Option<GoalIndexProjection>,
    pub duplicate_action: Option<String>,
    pub duplicate: Option<GoalAuthoringDuplicate>,
    pub move_result: Option<GoalAuthoringDuplicateMove>,
    pub requires_duplicate_decision: bool,
}

pub type FeatureGoalAuthoringResult = GoalAuthoringResult;
