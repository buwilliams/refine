...
pub(crate) fn settle_state_recovery_success(
    runtime_root: &Path,
    target_root: &Path,
    expected_health: &crate::application::persistence_sync::health::StateSyncHealth,
) -> RefineResult<(
    bool,
    crate::application::persistence_sync::health::StateSyncHealth,
)> {
...
fn append_state_sync_activity(
    ...
    report: Option<
        &crate::application::persistence_sync::conflict_reports::StateSyncConflictReport,
    >,
) -> RefineResult<()> {
