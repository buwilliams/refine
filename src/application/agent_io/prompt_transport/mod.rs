...
use crate::infrastructure::agents::invocation::ProviderPromptCapability;
use crate::infrastructure::process::launch_environment::EffectiveLaunchEnvironment;
...
pub(crate) fn prepare_prompt_with_environment(
    runtime_root: &Path,
    capability: ProviderPromptCapability,
    prompt: &str,
...
pub(crate) fn reap_orphan_prompt_artifacts(runtime_root: &Path) -> RefineResult<usize> {
