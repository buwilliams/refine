...
prompt_templates! {
    ...
    MissionInvestigation => "missions/investigation.md",
    MissionPlanningProposal => "missions/planning-proposal.md",
    MissionPlanningCriticism => "missions/planning-criticism.md",
    MissionPlanningRevision => "missions/planning-revision.md",
    MissionReduction => "missions/reduction.md",
    MissionCriticism => "missions/criticism.md",
    MissionSynthesis => "missions/synthesis.md",
    MissionQuality => "missions/quality.md",
    MissionGovernance => "missions/governance.md",
