...
use crate::application::system::installation::{
...
fn command_status(
    ...
    let output = FileProcessSupervisor::new(runtime_root).run_to_completion(ManagedProcessSpec {
        ...
        limits: Some(
            crate::infrastructure::process::subprocess::ProcessResourceLimits {
                stall_timeout_seconds: Some(10),
                ..crate::infrastructure::process::subprocess::ProcessResourceLimits::default()
            },
        ),
