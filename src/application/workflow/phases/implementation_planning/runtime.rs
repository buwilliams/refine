...
use crate::application::workflow::{now_timestamp, setting_usize};
...
pub(crate) struct PlanningPhaseRun {
...
pub(crate) fn run_observational_phase(
    ...
    let on_attention = |attention: crate::application::agents::sessions::GoalAgentAttention| {
        let _ = ctx.log(
            ...
            Some(crate::application::workflow::json_object(json!({
                "phase": phase,
