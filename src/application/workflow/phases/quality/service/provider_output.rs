...
#[derive(Clone, Debug)]
pub(crate) struct QualityTestDefinition {
...
impl ObservedExecution {
    ...
    pub(crate) fn shell_parser_aborted(&self) -> bool {
...
pub(crate) fn quality_command_harness_fault(
    command: &str,
...
pub(crate) fn quality_test_definitions(settings: &QualitySettings) -> Vec<QualityTestDefinition> {
...
pub(crate) fn shell_program_args(command: &str) -> (String, Vec<String>) {
    #[cfg(windows)]
    {
        (
            "cmd".to_string(),
