...
pub(crate) fn required_operation_request_string(
...
pub(crate) fn cancellation_requested(operation: &OperationHandle) -> bool {
    operation
        .request
...
pub(crate) fn recoverable_quality_cancellation(operation: &OperationHandle) -> bool {
