...
use crate::application::workflow::phases::quality::QualityCheckResult;
...
pub(crate) struct QualityRecoveryInvestigation {
    pub(crate) analysis: String,
    pub(crate) round_prompt: String,
    pub(crate) details: JsonObject,
}

pub(crate) fn quality_recovery_prompt(
    goal_id: &str,
    round_idx: usize,
    worktree_path: &str,
    context: &Value,
...
pub(crate) struct QualityRecoveryVerdict {
...
pub(crate) fn parse_quality_recovery_provider_output(
    output: &str,
