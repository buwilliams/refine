...
use crate::application::persistence_sync::state::{
    FileGitSyncService, STATE_COPY_COUNTER, StateSyncAttemptContext, is_goal_record,
};
...
impl FileGitSyncService {
    ...
    pub(crate) fn record_conflict_report(
        &self,
    ...
    pub(crate) fn escalated_decision_question(
        &self,
        remote_state_head: &str,
        unresolved: &[StateSyncConflictPath],
    ) -> Option<String> {
    ...
    pub(crate) fn clear_conflict_report(&self, report_id: &str) -> RefineResult<()> {
...
pub(crate) fn contended_records(unresolved: &[StateSyncConflictPath]) -> Vec<String> {
...
pub(crate) fn conflict_report_id(
    merge_base: &str,
    local_state_head: &str,
    remote_state_head: &str,
    unresolved: &[StateSyncConflictPath],
...
pub(crate) fn conflict_path_summary(
