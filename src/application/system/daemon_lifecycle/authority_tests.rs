...
use crate::application::system::installation::{InstallTarget, InstallationService};
...
fn uninstalling_registered_but_inactive_installation_stops_observed_direct_runtime() {
    ...
    let mut backend: crate::application::system::installation::InstallBackendRegistration =
    ...
    let process = supervisor
        .launch(ManagedProcessSpec {
            ...
            args: vec![
                "application::system::daemon_lifecycle::authority_tests::direct_runtime_listener_child"
                    .to_string(),
                "--exact".to_string(),
                "--ignored".to_string(),
                "--nocapture".to_string(),
