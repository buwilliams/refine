...
impl SourcePromotionHost for FileSourcePromotionHost {
    ...
    fn stop_daemon(&mut self) -> RefineResult<()> {
        let runtime_root = self.runtime_root()?;
        crate::application::system::daemon_lifecycle::execute_daemon_lifecycle(
            &crate::application::system::daemon_lifecycle::FileHostDaemonLifecycleService::new(
                RuntimeRoot { root: runtime_root },
                env!("CARGO_PKG_VERSION"),
            ),
            crate::application::system::daemon_lifecycle::DaemonLifecycleAction::Stop,
            crate::infrastructure::process::supervisor::lifecycle::BackgroundDaemonConfig {
    ...
    fn observe_previous_daemon(&mut self) -> SourcePromotionDaemonObservation {
        ...
        match crate::infrastructure::process::supervisor::lifecycle::http_reachability_probe(self.service.port) {
            crate::infrastructure::process::supervisor::lifecycle::DaemonReachability::Reachable => {
            ...
            crate::infrastructure::process::supervisor::lifecycle::DaemonReachability::Unreachable(error) => {
            ...
            crate::infrastructure::process::supervisor::lifecycle::DaemonReachability::Unknown(error) => {
                SourcePromotionDaemonObservation {
